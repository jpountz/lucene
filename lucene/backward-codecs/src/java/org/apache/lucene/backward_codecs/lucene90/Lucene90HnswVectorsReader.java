  ...
  static class OffHeapFloatVectorValues extends FloatVectorValues {
    ...
    public Dictionary dictionary() throws IOException {
      return new Dictionary() {
        ...
        int lastOrd = -1;
        final float[] value = new float[dimension];
    ...
    public VectorScorer scorer(float[] target) throws IOException {
      ...
      return new VectorScorer() {
        ...
        final Dictionary dict = values.dictionary();

        @Override
        public float score() throws IOException {
          return values.similarityFunction.compare(dict.vectorValue(iterator.index()), target);
        }
